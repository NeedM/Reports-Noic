report 50254 "Fixed Asset Acquisition"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './Fixed Asset Acquisition.rdl';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            column(CurrReport_PAGENO_Control1000000009; CurrReport.PageNo)
            {
            }
            ...
            column(Fixed_Asset__FA_Acquisition_Date_; "FA Acquisition Date")
            {
            }
            ...
            column(Revision_______00Caption; Revision_______00CaptionLbl)
            {
            }
            column(Issue_Date____January_2015Caption; Issue_Date____January_2015CaptionLbl)
            {
            }
            column(Page__Caption; Page__CaptionLbl)
            {
            }
            column(Prepared_by___Depot_ManagerCaption; Prepared_by___Depot_ManagerCaptionLbl)
            {
            }
            column(Form_Title___FIXED_ASSET_ACQUISITIONCaption; Form_Title___FIXED_ASSET_ACQUISITIONCaptionLbl)
            {
            }
            column(DO_001_1RECaption; DO_001_1RECaptionLbl)
            {
            }
            ...
            column(Fixed_Asset__FA_Acquisition_Date_Caption; FieldCaption("FA Acquisition Date"))
            {
            }
    ...
    var
        Text000: Label 'Fixed Asset Acquisition';
        ...
        Revision_______00CaptionLbl: Label 'Revision     : 00';
        Issue_Date____January_2015CaptionLbl: Label 'Issue Date  : January 2015';
        Page__CaptionLbl: Label 'Page :';
        Prepared_by___Depot_ManagerCaptionLbl: Label 'Prepared by : Depot Manager';
        Form_Title___FIXED_ASSET_ACQUISITIONCaptionLbl: Label 'Form Title : FIXED ASSET ACQUISITION';
        DO_001_1RECaptionLbl: Label 'DO 001-1RE';
