report 50257 "Fixed Asset  Fully Depreciated"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './Fixed Asset  Fully Depreciated.rdl';
    Caption = 'Fixed Asset Fully Depreciated';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            column(CompanyInformationPicture; "Company Information".Picture)
            {
            }
            ...
            begin
                ...
                ///// two lines added
                if BookValueAtEndingDate <> 1 then
                    CurrReport.Skip;
    ...
    var
        Text000: Label 'Fixed Assets Fully Depriciated';
